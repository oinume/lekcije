...
type Me interface {
	...
	DeleteFollowingTeacher(context.Context, *DeleteFollowingTeacherRequest) (*DeleteFollowingTeacherResponse, error)
...
func NewMeProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Me {
	...
	urls := [8]string{
		...
		serviceURL + "DeleteFollowingTeacher",
...
func (c *meProtobufClient) DeleteFollowingTeacher(ctx context.Context, in *DeleteFollowingTeacherRequest) (*DeleteFollowingTeacherResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "api.v1")
	ctx = ctxsetters.WithServiceName(ctx, "Me")
	ctx = ctxsetters.WithMethodName(ctx, "DeleteFollowingTeacher")
	caller := c.callDeleteFollowingTeacher
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *DeleteFollowingTeacherRequest) (*DeleteFollowingTeacherResponse, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*DeleteFollowingTeacherRequest)
					if !ok {
						return nil, twirp.InternalError("failed type assertion req.(*DeleteFollowingTeacherRequest) when calling interceptor")
					}
					return c.callDeleteFollowingTeacher(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*DeleteFollowingTeacherResponse)
				if !ok {
					return nil, twirp.InternalError("failed type assertion resp.(*DeleteFollowingTeacherResponse) when calling interceptor")
				}
				return typedResp, err
			}
			return nil, err
...
func (c *meProtobufClient) callDeleteFollowingTeacher(ctx context.Context, in *DeleteFollowingTeacherRequest) (*DeleteFollowingTeacherResponse, error) {
	out := new(DeleteFollowingTeacherResponse)
...
func (c *meJSONClient) DeleteFollowingTeacher(ctx context.Context, in *DeleteFollowingTeacherRequest) (*DeleteFollowingTeacherResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "api.v1")
	ctx = ctxsetters.WithServiceName(ctx, "Me")
	ctx = ctxsetters.WithMethodName(ctx, "DeleteFollowingTeacher")
	caller := c.callDeleteFollowingTeacher
...
func (c *meJSONClient) callDeleteFollowingTeacher(ctx context.Context, in *DeleteFollowingTeacherRequest) (*DeleteFollowingTeacherResponse, error) {
	out := new(DeleteFollowingTeacherResponse)
...
func (s *meServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	case "CreateFollowingTeacher":
		...
		return
	case "DeleteFollowingTeacher":
		s.serveDeleteFollowingTeacher(ctx, resp, req)
		return
...
func (s *meServer) serveDeleteFollowingTeacher(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveDeleteFollowingTeacherJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveDeleteFollowingTeacherProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *meServer) serveDeleteFollowingTeacherJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "DeleteFollowingTeacher")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	reqContent := new(DeleteFollowingTeacherRequest)
	unmarshaler := protojson.UnmarshalOptions{DiscardUnknown: true}
	if err = unmarshaler.Unmarshal(rawReqBody, reqContent); err != nil {
		s.handleRequestBodyError(ctx, resp, "the json request could not be decoded", err)
		return
	...
	handler := s.Me.DeleteFollowingTeacher
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *DeleteFollowingTeacherRequest) (*DeleteFollowingTeacherResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*DeleteFollowingTeacherRequest)
					if !ok {
					...
					return s.Me.DeleteFollowingTeacher(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*DeleteFollowingTeacherResponse)
	...
	// Call service method
	var respContent *DeleteFollowingTeacherResponse
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
		respContent, err = handler(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *DeleteFollowingTeacherResponse and nil error while calling DeleteFollowingTeacher. nil responses are not supported"))
		return
	}
...
func (s *meServer) serveDeleteFollowingTeacherProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "DeleteFollowingTeacher")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
