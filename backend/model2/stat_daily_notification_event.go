...
func StatDailyNotificationEvents(mods ...qm.QueryMod) statDailyNotificationEventQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`stat_daily_notification_event`.*"})
	}

	return statDailyNotificationEventQuery{q}
}
...
func (o *StatDailyNotificationEvent) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return StatDailyNotificationEventExists(ctx, exec, o.Date, o.Event)
}
