...
func (q statDailyNotificationEventQuery) One(ctx context.Context, exec boil.ContextExecutor) (*StatDailyNotificationEvent, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mysql: failed to execute a one query for stat_daily_notification_event")
	}
...
func (q statDailyNotificationEventQuery) All(ctx context.Context, exec boil.ContextExecutor) (StatDailyNotificationEventSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "mysql: failed to assign all query results to StatDailyNotificationEvent slice")
	}
...
func (q statDailyNotificationEventQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to count stat_daily_notification_event rows")
	}
...
func (q statDailyNotificationEventQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mysql: failed to check if stat_daily_notification_event exists")
	}
...
func FindStatDailyNotificationEvent(ctx context.Context, exec boil.ContextExecutor, date time.Time, event string, selectCols ...string) (*StatDailyNotificationEvent, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mysql: unable to select from stat_daily_notification_event")
	}
...
func (o *StatDailyNotificationEvent) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("mysql: no stat_daily_notification_event provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to insert into stat_daily_notification_event")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to populate default values for stat_daily_notification_event")
	}
...
func (o *StatDailyNotificationEvent) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("mysql: unable to update stat_daily_notification_event, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to update stat_daily_notification_event row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to get rows affected by update for stat_daily_notification_event")
	}
...
func (q statDailyNotificationEventQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to update all for stat_daily_notification_event")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to retrieve rows affected for stat_daily_notification_event")
	}
...
func (o StatDailyNotificationEventSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to update all in statDailyNotificationEvent slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to retrieve rows affected all in update all statDailyNotificationEvent")
	}
	return rowsAff, nil
}
...
func (o *StatDailyNotificationEvent) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("mysql: no stat_daily_notification_event provided for upsert")
	}
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("mysql: unable to upsert stat_daily_notification_event, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to upsert for stat_daily_notification_event")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to retrieve unique values for stat_daily_notification_event")
	}
...
func (o *StatDailyNotificationEvent) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("mysql: no StatDailyNotificationEvent provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to delete from stat_daily_notification_event")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to get rows affected by delete for stat_daily_notification_event")
	}
...
func (q statDailyNotificationEventQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("mysql: no statDailyNotificationEventQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to delete all from stat_daily_notification_event")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to get rows affected by deleteall for stat_daily_notification_event")
	}
...
func (o StatDailyNotificationEventSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to delete all from statDailyNotificationEvent slice")
	}
...
func (o *StatDailyNotificationEventSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to reload all in StatDailyNotificationEventSlice")
	}
...
func StatDailyNotificationEventExists(ctx context.Context, exec boil.ContextExecutor, date time.Time, event string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mysql: unable to check if stat_daily_notification_event exists")
	}
