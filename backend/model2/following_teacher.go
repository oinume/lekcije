...
func (q followingTeacherQuery) One(ctx context.Context, exec boil.ContextExecutor) (*FollowingTeacher, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mysql: failed to execute a one query for following_teacher")
	}
...
func (q followingTeacherQuery) All(ctx context.Context, exec boil.ContextExecutor) (FollowingTeacherSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "mysql: failed to assign all query results to FollowingTeacher slice")
	}
...
func (q followingTeacherQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to count following_teacher rows")
	}
...
func (q followingTeacherQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mysql: failed to check if following_teacher exists")
	}
...
func FindFollowingTeacher(ctx context.Context, exec boil.ContextExecutor, userID uint, teacherID uint, selectCols ...string) (*FollowingTeacher, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mysql: unable to select from following_teacher")
	}
...
func (o *FollowingTeacher) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("mysql: no following_teacher provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to insert into following_teacher")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to populate default values for following_teacher")
	}
...
func (o *FollowingTeacher) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("mysql: unable to update following_teacher, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to update following_teacher row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to get rows affected by update for following_teacher")
	}
...
func (q followingTeacherQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to update all for following_teacher")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to retrieve rows affected for following_teacher")
	}
...
func (o FollowingTeacherSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to update all in followingTeacher slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to retrieve rows affected all in update all followingTeacher")
	}
	return rowsAff, nil
}
...
func (o *FollowingTeacher) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("mysql: no following_teacher provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("mysql: unable to upsert following_teacher, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to upsert for following_teacher")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to retrieve unique values for following_teacher")
	}
...
func (o *FollowingTeacher) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("mysql: no FollowingTeacher provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to delete from following_teacher")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to get rows affected by delete for following_teacher")
	}
...
func (q followingTeacherQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("mysql: no followingTeacherQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to delete all from following_teacher")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to get rows affected by deleteall for following_teacher")
	}
...
func (o FollowingTeacherSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to delete all from followingTeacher slice")
	}
...
func (o *FollowingTeacherSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to reload all in FollowingTeacherSlice")
	}
...
func FollowingTeacherExists(ctx context.Context, exec boil.ContextExecutor, userID uint, teacherID uint) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mysql: unable to check if following_teacher exists")
	}
