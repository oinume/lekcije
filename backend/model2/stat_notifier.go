...
var (
	...
	statNotifierGeneratedColumns      = []string{}
)
...
func StatNotifiers(mods ...qm.QueryMod) statNotifierQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`stat_notifier`.*"})
	}

	return statNotifierQuery{q}
}
...
func (o *StatNotifier) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return StatNotifierExists(ctx, exec, o.Datetime, o.Interval)
}
