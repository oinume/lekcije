...
func (q statNewLessonNotifierQuery) One(ctx context.Context, exec boil.ContextExecutor) (*StatNewLessonNotifier, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mysql: failed to execute a one query for stat_new_lesson_notifier")
	}
...
func (q statNewLessonNotifierQuery) All(ctx context.Context, exec boil.ContextExecutor) (StatNewLessonNotifierSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "mysql: failed to assign all query results to StatNewLessonNotifier slice")
	}
...
func (q statNewLessonNotifierQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to count stat_new_lesson_notifier rows")
	}
...
func (q statNewLessonNotifierQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mysql: failed to check if stat_new_lesson_notifier exists")
	}
...
func FindStatNewLessonNotifier(ctx context.Context, exec boil.ContextExecutor, date time.Time, event string, selectCols ...string) (*StatNewLessonNotifier, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mysql: unable to select from stat_new_lesson_notifier")
	}
...
func (o *StatNewLessonNotifier) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("mysql: no stat_new_lesson_notifier provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to insert into stat_new_lesson_notifier")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to populate default values for stat_new_lesson_notifier")
	}
...
func (o *StatNewLessonNotifier) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("mysql: unable to update stat_new_lesson_notifier, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to update stat_new_lesson_notifier row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to get rows affected by update for stat_new_lesson_notifier")
	}
...
func (q statNewLessonNotifierQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to update all for stat_new_lesson_notifier")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to retrieve rows affected for stat_new_lesson_notifier")
	}
...
func (o StatNewLessonNotifierSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to update all in statNewLessonNotifier slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to retrieve rows affected all in update all statNewLessonNotifier")
	}
	return rowsAff, nil
}
...
func (o *StatNewLessonNotifier) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("mysql: no stat_new_lesson_notifier provided for upsert")
	}
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("mysql: unable to upsert stat_new_lesson_notifier, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to upsert for stat_new_lesson_notifier")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to retrieve unique values for stat_new_lesson_notifier")
	}
...
func (o *StatNewLessonNotifier) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("mysql: no StatNewLessonNotifier provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to delete from stat_new_lesson_notifier")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to get rows affected by delete for stat_new_lesson_notifier")
	}
...
func (q statNewLessonNotifierQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("mysql: no statNewLessonNotifierQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to delete all from stat_new_lesson_notifier")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to get rows affected by deleteall for stat_new_lesson_notifier")
	}
...
func (o StatNewLessonNotifierSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to delete all from statNewLessonNotifier slice")
	}
...
func (o *StatNewLessonNotifierSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to reload all in StatNewLessonNotifierSlice")
	}
...
func StatNewLessonNotifierExists(ctx context.Context, exec boil.ContextExecutor, date time.Time, event string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mysql: unable to check if stat_new_lesson_notifier exists")
	}
