...
func (q userAPITokenQuery) One(ctx context.Context, exec boil.ContextExecutor) (*UserAPIToken, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mysql: failed to execute a one query for user_api_token")
	}
...
func (q userAPITokenQuery) All(ctx context.Context, exec boil.ContextExecutor) (UserAPITokenSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "mysql: failed to assign all query results to UserAPIToken slice")
	}
...
func (q userAPITokenQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to count user_api_token rows")
	}
...
func (q userAPITokenQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mysql: failed to check if user_api_token exists")
	}
...
func FindUserAPIToken(ctx context.Context, exec boil.ContextExecutor, token string, selectCols ...string) (*UserAPIToken, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mysql: unable to select from user_api_token")
	}
...
func (o *UserAPIToken) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("mysql: no user_api_token provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to insert into user_api_token")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to populate default values for user_api_token")
	}
...
func (o *UserAPIToken) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("mysql: unable to update user_api_token, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to update user_api_token row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to get rows affected by update for user_api_token")
	}
...
func (q userAPITokenQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to update all for user_api_token")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to retrieve rows affected for user_api_token")
	}
...
func (o UserAPITokenSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to update all in userAPIToken slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to retrieve rows affected all in update all userAPIToken")
	}
	return rowsAff, nil
}
...
func (o *UserAPIToken) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("mysql: no user_api_token provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("mysql: unable to upsert user_api_token, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to upsert for user_api_token")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to retrieve unique values for user_api_token")
	}
...
func (o *UserAPIToken) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("mysql: no UserAPIToken provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to delete from user_api_token")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to get rows affected by delete for user_api_token")
	}
...
func (q userAPITokenQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("mysql: no userAPITokenQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to delete all from user_api_token")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to get rows affected by deleteall for user_api_token")
	}
...
func (o UserAPITokenSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to delete all from userAPIToken slice")
	}
...
func (o *UserAPITokenSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to reload all in UserAPITokenSlice")
	}
...
func UserAPITokenExists(ctx context.Context, exec boil.ContextExecutor, token string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mysql: unable to check if user_api_token exists")
	}
