...
func (q notificationTimeSpanQuery) One(ctx context.Context, exec boil.ContextExecutor) (*NotificationTimeSpan, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mysql: failed to execute a one query for notification_time_span")
	}
...
func (q notificationTimeSpanQuery) All(ctx context.Context, exec boil.ContextExecutor) (NotificationTimeSpanSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "mysql: failed to assign all query results to NotificationTimeSpan slice")
	}
...
func (q notificationTimeSpanQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to count notification_time_span rows")
	}
...
func (q notificationTimeSpanQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mysql: failed to check if notification_time_span exists")
	}
...
func FindNotificationTimeSpan(ctx context.Context, exec boil.ContextExecutor, userID uint, number uint8, selectCols ...string) (*NotificationTimeSpan, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mysql: unable to select from notification_time_span")
	}
...
func (o *NotificationTimeSpan) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("mysql: no notification_time_span provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to insert into notification_time_span")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to populate default values for notification_time_span")
	}
...
func (o *NotificationTimeSpan) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("mysql: unable to update notification_time_span, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to update notification_time_span row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to get rows affected by update for notification_time_span")
	}
...
func (q notificationTimeSpanQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to update all for notification_time_span")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to retrieve rows affected for notification_time_span")
	}
...
func (o NotificationTimeSpanSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to update all in notificationTimeSpan slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to retrieve rows affected all in update all notificationTimeSpan")
	}
	return rowsAff, nil
}
...
func (o *NotificationTimeSpan) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("mysql: no notification_time_span provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("mysql: unable to upsert notification_time_span, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to upsert for notification_time_span")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to retrieve unique values for notification_time_span")
	}
...
func (o *NotificationTimeSpan) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("mysql: no NotificationTimeSpan provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to delete from notification_time_span")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to get rows affected by delete for notification_time_span")
	}
...
func (q notificationTimeSpanQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("mysql: no notificationTimeSpanQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to delete all from notification_time_span")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to get rows affected by deleteall for notification_time_span")
	}
...
func (o NotificationTimeSpanSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to delete all from notificationTimeSpan slice")
	}
...
func (o *NotificationTimeSpanSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to reload all in NotificationTimeSpanSlice")
	}
...
func NotificationTimeSpanExists(ctx context.Context, exec boil.ContextExecutor, userID uint, number uint8) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mysql: unable to check if notification_time_span exists")
	}
