...
func (q mPlanQuery) One(ctx context.Context, exec boil.ContextExecutor) (*MPlan, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mysql: failed to execute a one query for m_plan")
	}
...
func (q mPlanQuery) All(ctx context.Context, exec boil.ContextExecutor) (MPlanSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "mysql: failed to assign all query results to MPlan slice")
	}
...
func (q mPlanQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to count m_plan rows")
	}
...
func (q mPlanQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mysql: failed to check if m_plan exists")
	}
...
func FindMPlan(ctx context.Context, exec boil.ContextExecutor, iD uint8, selectCols ...string) (*MPlan, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mysql: unable to select from m_plan")
	}
...
func (o *MPlan) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("mysql: no m_plan provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to insert into m_plan")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to populate default values for m_plan")
	}
...
func (o *MPlan) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("mysql: unable to update m_plan, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to update m_plan row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to get rows affected by update for m_plan")
	}
...
func (q mPlanQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to update all for m_plan")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to retrieve rows affected for m_plan")
	}
...
func (o MPlanSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to update all in mPlan slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to retrieve rows affected all in update all mPlan")
	}
	return rowsAff, nil
}
...
func (o *MPlan) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("mysql: no m_plan provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("mysql: unable to upsert m_plan, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to upsert for m_plan")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to retrieve unique values for m_plan")
	}
...
func (o *MPlan) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("mysql: no MPlan provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to delete from m_plan")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to get rows affected by delete for m_plan")
	}
...
func (q mPlanQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("mysql: no mPlanQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to delete all from m_plan")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "mysql: failed to get rows affected by deleteall for m_plan")
	}
...
func (o MPlanSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "mysql: unable to delete all from mPlan slice")
	}
...
func (o *MPlanSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "mysql: unable to reload all in MPlanSlice")
	}
...
func MPlanExists(ctx context.Context, exec boil.ContextExecutor, iD uint8) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mysql: unable to check if m_plan exists")
	}
