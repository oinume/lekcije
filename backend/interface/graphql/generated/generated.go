...
func (ec *executionContext) unmarshalInputUpdateNotificationTimeSpansInput(ctx context.Context, obj interface{}) (model.UpdateNotificationTimeSpansInput, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "timeSpans":
			...
			data, err := ec.unmarshalNNotificationTimeSpanInput2ᚕᚖgithubᚗcomᚋoinumeᚋlekcijeᚋbackendᚋinterfaceᚋgraphqlᚋmodelᚐNotificationTimeSpanInputᚄ(ctx, v)
			if err != nil {
				return it, err
			}
			it.TimeSpans = data
